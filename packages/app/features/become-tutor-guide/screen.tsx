...
import { GuideHighlightCard } from './components/guide-highlight-card';
import { GuideStepCard } from './components/guide-step-card';

export function BecomeTutorGuideScreen() {
